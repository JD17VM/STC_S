...
<head>
  ...
  <script>
    ...
    function llenarFormularioModificar(id, puesto, servidor, profesion, correo, telefono, descripcion) {
      ...
      <div class="cuerpo_formulario">
        ...
        <form action="index.php" method="post" enctype="multipart/form-data">
          <div class="campo_texto">
            ...
            <div>
              <button class="boton_normal"><input type="file" name="imagen" id="imagen"></button>
            </div>
          </div>
          <div class="campo_texto">
  ...
  <div class="superpuesto" id="sup_modificar">
    <div class="formulario_agregar">
      ...
      <div class="cuerpo_formulario">
        ...
        <form action="index.php" method="post" enctype="multipart/form-data">
          <div class="campo_texto">
            <label for="imagen_modificar">Seleccionar imagen:</label>
            <div>
              <button class="boton_normal"><input type="file" name="imagen_modificar" id="imagen_modificar"></button>
            </div>
          </div>
          <div class="campo_texto">
